...
;; GM this works with inserting the no-header-body
...
otherwise export the entire body."
  ...
  (let* ((region-p (org-region-active-p))
         ...
         (html-end (or (and region-p (region-end))
                       ...
                       (point-max)))
	 ;; GM insertions
	 (pre-body (buffer-substring html-start html-end))
    ...
    (save-excursion
      ...
      (insert (org-mime-multipart
	       ...
	       pre-body html (mapconcat 'identity html-images "\n"))))))
...
(defun org-mime-compose (body fmt file &optional to subject headers)
  ...
  (let ((bhook
    ...
    (cond
     ...
     ;; GM: this is what org-mime-htmlize-org-buffer calls
     ((or (eq fmt 'html) (eq fmt 'html-ascii))
      ...
      (let* ((org-link-file-path-type 'absolute)
	     ...
	     (org-export-htmlize-output-type 'inline-css)
	     ;; GM-added this. dvipng for inline latex because MathJax doesn't work in mail
	 (org-html-with-latex 'dvipng)
	     ;; GM insertions
	     (post-body (concat org-mime-default-header
				body))
	     ;; replace body with post-body for html export
	     (html-and-images
	      (org-mime-replace-images
	       (org-export-string-as (funcall bhook post-body 'html) 'html t))) 
